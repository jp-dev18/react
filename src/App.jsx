    ...
    >
      ...
      <main className="h-full w-full flex justify-center items-center overflow-hidden">
        <section className="border rounded-lg border-gray-500 min-w-96 flex items-center justify-center gap-4 p-6 flex-col">
          <img
            src="https://github.com/jp-dev18.png"
            alt="foto do usuário"
            className="border-4 border-gray-300 w-32 h-32 rounded-full hover:scale-350 transition-all"
          />
          ...
          >
            <Botao>
              <a
                target="_blank"
                href="https://www.instagram.com/sant0forte/?next=%2F"
            ...
            <Botao>
              <a
                target="_blank"
                href="https://www.linkedin.com/in/joao-pedro-maciel-ferreira-3256b936a/"
                className="flex items-center gap-4 w-full h-full px-4 py-2 justify-center"
              >
            ...
            <Botao>
              <a
                target="_blank"
                href="https://www.facebook.com/Joao.Pedro.mofi"
                className="flex items-center gap-4 w-full h-full px-4 py-2 justify-center"
              >
